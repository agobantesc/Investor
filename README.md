...
- **Operador y costos · ganancia real neta:** en **Configuración → Operador y costos** eliges la corredora (BTG Pactual, Trii u otra) e indicas la **comisión por operación (%)**, si **agrega IVA (19%)**, la **comisión mínima y máxima** y el **impuesto a la ganancia de capital (%)**. La **Contabilidad** descuenta esas comisiones en **cada compra y venta** y el impuesto sobre la ganancia realizada, y muestra el **Resultado real (neto de costos)**: *Ganancia bruta − comisiones − impuesto = ganancia real* ($ y %), con la **comisión por operación** en el libro y en el informe del contador. La configuración del operador es **global** (igual para todos los clientes). El impuesto por defecto es 0% (acciones con presencia bursátil exentas, art. 107 LIR).
