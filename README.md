...
- **Inicio (Home):** al abrir INVERSOR aterrizas en un **resumen general** — el **patrimonio total gestionado** (todos los proyectos de todos los clientes), la **rentabilidad neta consolidada**, un ranking de **proyectos más rentables** (para comparar carteras: invierte montos chicos en distintas combinaciones y mide cuál rinde mejor), las **acciones destacadas** por Sharpe de tu análisis activo, los **indicadores de mercado que más se movieron** y accesos rápidos.
