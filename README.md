...
- **Carga de precios de cierre:** desde el Home (botón **↻ Actualizar precios**) cargas el **cierre de un día** (IPSA + cada acción con seguimiento) y se agrega como nuevo punto de valoración a **todos tus proyectos que tengan esas acciones**.
...
- **Navegación:** sidebar con **Inicio** arriba y los módulos de trabajo (**Análisis · Simulación · Inversión**); **Proyectos · Perfil · Mercados** en la barra superior; **Pro · Roadmap** desde **Configuración (⚙)**.
