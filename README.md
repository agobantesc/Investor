...
- **Listo para la declaración de renta:** la Contabilidad muestra el **Resultado realizado por venta** — cada venta con **fecha, precio, monto, costo promedio de adquisición, comisión (con IVA)** y su **resultado neto** (lo que de verdad ganaste o perdiste), más el total del mayor valor realizado. El **libro de operaciones** detalla cada compra/venta con **comisión, IVA desglosado y efectivo** (dinero realmente movido). El **informe para el contador** agrupa las ventas **por año tributario** con subtotales y el **mayor valor neto realizado**, listo para tu declaración de renta anual.
