...
- **Menú lateral en dos grupos:** **Flujo de trabajo** (**Análisis · Simulación · Inversión**) y **Gestión** (**Proyectos · Clientes · Perfil · Mercados**). El **Pro · Roadmap** se abre desde **Configuración (⚙)**.
